                ...
                while ($filaHijo = mysqli_fetch_assoc($resultadoHijos)) {
                    ...
                    if ($resultadoAlumno) {
                        while ($datosAlumno = mysqli_fetch_assoc($resultadoAlumno)) {
                            ...
                            echo '<a href="salidashijos(padres).php?dniAlumno='.$dniAlumno.'" class="btn border-bottom border-top form-control" style="width: 100%;">'.$apellidoAlumno.' '.$nombreAlumno.'</a><br><br>';
                        }
                    } else {
