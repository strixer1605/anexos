<?php
    ...
    $query = "SELECT estado, anexoviiiHabil, planillaHabilitada FROM anexoiv WHERE idAnexoIV = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $anexoVIIItexto = ($row['anexoviiiHabil'] == 1) ? ' / Anexo VIII' : '';
        $planillatexto = ($row['planillaHabilitada'] == 1) ? ' / Planilla Informativa' : '';
    }
    $stmt->close();
?>
