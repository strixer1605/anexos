...
<center>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                Costa</b>, a participar de la Salida Educativa <b>Ahora es Tiempo de Sumar XIV</b>, a
                realizarse en las localidades de Villa La Angostura, San Carlos de Bariloche a
                realizarse entre los días 22 de Octubre y el 03 de Noviembre del presente ciclo
                lectivo.</p>
            ...
            <div class="row">
               ...
               <div class="col-6">
                 Lugar: <input type="text" id="lugar" class="form-control-sm border-primary"></br>
                 Fecha: <input type="date" id="fecha" class="form-control-sm border-primary"></br>
                 Firma y aclaración del Padre, Madre, Tutor o Representante Legal: ............................</br>
                 DNI: <input type="number" id="dnipa" class="form-control-sm border-primary">
               </div>
               <div class="col-3">
               </div>
            </div></br>
