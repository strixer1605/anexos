        ...
        if ($stmt->execute()) {
            ...
            echo '
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control item" id="nombreConductor2" name="nombreConductor2" placeholder="Ingrese el nombre del conductor 2..." value="'.htmlspecialchars($row['nombreConductor2'], ENT_QUOTES, 'UTF-8').'" required>
                </div>

                <div class="form-group">
                    <label for="dniConductor2" class="form-label">DNI del Conductor 2:</label>
                    <input type="text" class="form-control item" id="dniConductor2" name="dniConductor2" placeholder="Ingrese el DNI del conductor 2..." value="'.htmlspecialchars($row['dniConductor2'], ENT_QUOTES, 'UTF-8').'" required>
                </div>

                <div class="form-group">
                    <label for="licenciaConductor2" class="form-label">Licencia del Conductor 2:</label>
                    <input type="text" class="form-control item" id="licenciaConductor2" name="licenciaConductor2" placeholder="Ingrese la licencia del conductor 2..." value="'.htmlspecialchars($row['numeroLicencia2'], ENT_QUOTES, 'UTF-8').'" required>
                    <p style="margin-top: 5px; margin-left: 2px;">Nota: La licencia debe coincidir con el DNI.</p>    
                </div>

                <div class="form-group">
                    <label for="vigenciaConductor2" class="form-label">Vigencia del Conductor 2:</label>
                    <input type="date" class="form-control item" id="vigenciaConductor2" name="vigenciaConductor2" placeholder="Ingrese la vigencia de la licencia del conductor 2..." value="'.htmlspecialchars($row['vigencia2'], ENT_QUOTES, 'UTF-8').'" required>
                </div>
            ';
        } else {
