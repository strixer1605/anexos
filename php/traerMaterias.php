<?php
    ...
    echo '<div class="form-group">
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control item" id="materias" name="materias" placeholder="Aquí aparecerán los materias que haya ingresado..." value="' .htmlspecialchars($row['area'], ENT_QUOTES, 'UTF-8'). '" required readonly>
            </div>
