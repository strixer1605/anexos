<?php
    ...
    $sqlCheck = "SELECT * FROM `anexovi` WHERE `dniAlumno` = '$dniAlumno' AND `fkAnexoIV` = '$idSalida'";
    ...
    if (mysqli_num_rows($resultCheck) > 0) {
        ...
        if ($row['dniPadre'] === $dniPadre) {
            ...
            $sqlUpdate = "UPDATE `anexovi` 
                        ...
                        WHERE `dniAlumno` = '$dniAlumno' AND `fkAnexoIV` = '$idSalida'";
            ...
            $sqlInsert = "INSERT INTO `anexovi`(`fkAnexoIV`, `dniAlumno`, `domicilio`, `altura`, `localidad`, `dniPadre`) 
                        VALUES ('$idSalida', '$dniAlumno', '$domicilio', '$altura', '$localidad', '$dniPadre')";
